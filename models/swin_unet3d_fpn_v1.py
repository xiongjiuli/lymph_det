...
class SwinUnet3D(nn.Module):
    ...
    def forward(self, img):
        ...
        up12_dec = nn.Conv3d(96, 64, kernel_size=1, stride=1, padding=0).cuda()
...
def swinUnet_3D_fpn(hidden_dim=96, layers=(2, 2, 4, 2), heads=(3, 6, 9, 12), num_classes: int = 2, **kwargs):
...
if __name__ == '__main__':
    ...
    seg = swinUnet_3D_fpn(hidden_dim=96, layers=(2, 2, 6, 2), heads=(3, 6, 12, 24),
